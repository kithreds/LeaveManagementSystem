    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3 mt-5">
                ...
                <a href="view holiday admin.html"
                    class="list-group-item list-group-item-action bg-transparent second-text fw-bold me-2"><i
                ...
                <a href="view Employee details Admin.html"
                    class="list-group-item list-group-item-action bg-transparent second-text fw-bold me-2"><i
                        class="bi bi-person-plus"></i>
                    View Employee </a>


                <a href="Admin leave approve.html"
                    class="list-group-item list-group-item-action bg-transparent second-text fw-bold me-2"><i
        ...
        <form action="update" onsubmit="return validateForm()">
          ...
          <input type="hidden" name="status" value="active">
            ...
            <div class="input-box">
              ...
              <input type="text" id="name" name="reportingmanager" value="${employee.reportingmanager}" class="form-control">
              <span id="nameError" class="text-danger"></span>
            </div>
